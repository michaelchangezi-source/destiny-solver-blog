...
<section class="seo">
  <h2>六爻排盤計算什麼</h2>
  <p>六爻是一套以《易經》六十四卦問事的術數：帶著一個明確的問題，三枚硬幣搖擲六次得出一支卦，之後按京房納甲配干支、六親、六獸與世應，再結合起卦當日的月建日辰解讀。本工具排出本卦與變卦（卦名、所屬八宮、世應爻位）、每一爻的納甲干支與六親六獸、動爻及其化出、旬空月破日沖標記，以及六親不全時的伏神。與八字不同，六爻不需出生時間，問的是「此事當下狀況與後續走向」。</p>
  <h2>如何把六爻卦交給 ChatGPT 分析？</h2>
  <p>請求 AI「幫我搖一卦」並無實際意義：AI 生成的只是文字，並非您親手起的卦；以口頭描述「一背兩字」讓 AI 裝卦，納甲世應極易排錯，起卦當日的日辰旬空更是全憑推測。正確分工是：親手搖卦，由本工具負責裝卦排盤，然後複製「Prompt＋資料包」貼至 ChatGPT、Claude 或 Gemini，AI 只負責解讀一份已正確排出的結構化卦象。</p>
  <h2>六爻排盤常見誤解</h2>
  <p>第一，同一件事短時間內反覆搖卦：六爻重一事一問，反覆提問只會令訊息更混亂。第二，見到「官鬼」「白虎」便視為壞消息：六親六獸是功能符號，官鬼在問事業時正是代表工作與職位，吉凶須看用神旺衰與動爻生剋，不能只看名稱。第三，忽略旬空月破：爻落旬空或月破，力量與應期均有所不同，資料包會逐爻標明，令 AI 無需推測。</p>
  <h2>常見問題</h2>
  <div class="faq-item"><h3>Q1　六爻需要輸入出生時間嗎？</h3><p>不需要。六爻以起卦時刻與卦象為準，不需要任何出生資料，所問之事方為主角。</p></div>
  <div class="faq-item"><h3>Q2　本人未曾搖過卦，如何入門？</h3><p>準備三枚相同的硬幣，心中默想一事，雙手覆著硬幣搖勻後擲於桌上，記錄背面的數量；重複六次，按先後次序由初爻錄至上爻。不便使用硬幣者，可使用「線上模擬搖卦」。</p></div>
  <div class="faq-item"><h3>Q3　什麼是世應？</h3><p>世爻代表自身（問事人），應爻代表對方或所問之事的另一方。工具按京房八宮構造法自動標出世應位置。</p></div>
  <div class="faq-item"><h3>Q4　什麼是伏神？</h3><p>當卦中六親不齊（例如問財但卦中無財爻），須至本宮首卦找回所缺的六親，稱為伏神。資料包將列明伏神干支、伏於哪一爻之下、飛神為何。</p></div>
  <div class="faq-item"><h3>Q5　將資料包貼給 AI 之後，AI 會否隨意補充？</h3><p>資料包附有使用規則：以資料包為唯一卦面事實、不得重新裝卦、未列出的資料須直接說明。若 AI 輸出的卦面與資料包不一致，以資料包為準。</p></div>
  <div class="faq-item"><h3>Q6　此工具需要付費嗎？</h3><p>不需要。六爻排盤與 AI 資料包全部免費，免登入、免安裝。</p></div>
</section>
