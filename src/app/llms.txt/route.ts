...
本站提供 8 個免費命理排盤與占卜工具，分兩類：排盤類（四柱八字、紫微斗數、西洋占星、印度占星）用於建立命盤結構；占卜類（六爻、奇門遁甲、塔羅、雷諾曼）用於即時問事，均附結構化 AI 解讀資料包，可直接複製給 ChatGPT、Claude 或 Gemini 深入分析，無需任何命理知識即可使用。工具總覽：[${BASE_URL}/tools](${BASE_URL}/tools)
...
- [印度占星](${BASE_URL}/vedic)：以 Lahiri 恆星黃道計算九曜、二十七宿、D1 至 D60 十六分盤及 Vimshottari 大運

### 占卜類（即時問事，附 AI 解讀資料包）

- [六爻占卜排盤](${BASE_URL}/liuyao)：想問一件具體之事的當下走向與進退，線上起卦或親手搖卦錄入，自動排出本卦變卦、六親六獸、旬空月破伏神，附 AI 資料包可複製給 ChatGPT／Claude／Gemini 解讀，不需出生時間
- [奇門遁甲占卜](${BASE_URL}/qimen)：想看一件事此刻的局勢與行動方向，轉盤時家拆補定局，自動排出九宮天地盤、門星神、值符值使，附 AI 資料包，不需出生時間
