...
export const metadata = buildMetadata({
  title: '免費排盤工具箱｜八字六爻奇門塔羅紫微西洋｜命運解決師 陳卓賢',
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12 space-y-3">
          ...
          <p className="text-[#6B6155] text-sm max-w-lg mx-auto">
            排準、可核對。八個工具免登入即用，占卜類工具另支援複製 AI 解讀資料包貼去 ChatGPT 深入分析。
          </p>
        </div>

        {/* 排盤類四個工具 */}
        <div className="mb-10">
          <p className="text-[#6B6155] text-[11px] tracking-[0.25em] uppercase mb-4">排盤類 — 命盤結構，無 AI 資料包</p>
