  ...
  return (
    <>
      ...
      <div className="mt-12 bg-gradient-to-br from-[#B23E26]/15 to-transparent border border-[#B23E26]/25 rounded p-6 text-center">
        ...
        <Link
          href="/consultation"
          className="inline-block bg-[#E0552C] hover:bg-[#C9461F] text-[#F7F1E5] font-bold px-6 py-3 rounded transition-[background-color,box-shadow,transform] hover:shadow-[0_10px_24px_-10px_rgba(178,62,38,0.55)] active:scale-[0.97] text-sm"
        >
          預約諮詢
        </Link>
      </div>
