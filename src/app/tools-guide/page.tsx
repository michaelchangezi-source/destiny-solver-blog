...
const faq = [
  ...
  {
    q: '網上排盤同手機 App 邊樣好用？',
    a: '各有優勝之處。網站版毋須下載、毋須更新，直接在瀏覽器開即用，適合臨時查閱；手機 App 通常有本機保存紀錄，適合長期追蹤。如果需要複製資料包貼去 AI，網站版在複製貼上流程上更順暢。',
  },
  {
    q: '排盤結果可唔可以貼畀 ChatGPT 解？',
    a: '問事類工具（六爻、奇門、塔羅、雷諾曼）有結構化 AI 解讀資料包，一鍵複製後直接貼去 ChatGPT、Claude 或 Gemini 即可。命盤類工具（八字、紫微）涉及格局、大運與應期的立體判斷，AI 難以取代人手分析，建議預約深度諮詢。',
  },
  {
    q: '點解唔同網站排出嚟有出入？',
    a: '排盤口徑差異是主因。八字的節氣時刻（影響月柱）、奇門的拆補或置閏法、六爻的換日時間（23:00 或 00:00），各站設定不同都會導致結果不同。選擇工具時，優先看口徑是否透明寫明，才有辦法核對對錯。',
  },
]
    ...
    <main className="pt-24 pb-20 px-4">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12 bg-[#FFFDF8] rounded-2xl border border-[#2B241C]/10 p-8">
          <h2 className="text-[#2B241C] text-xl font-bold mb-4">排盤之後點解讀？</h2>
          <p className="text-[#5A5247] text-sm leading-relaxed mb-4">
            排出結果後有三條路可以走：
          </p>
