  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-[#FAFAF8]/95 backdrop-blur-sm border-b border-[#2B241C]/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2.5 group py-[3px] -my-[3px]">
        ...
        <nav className="hidden md:flex items-center gap-7">
          ...
          <div className="group nav-dropdown-trigger relative flex items-center h-16">
            <Link
              href="/bazi"
              className={`flex items-center gap-1 text-sm tracking-wide transition-colors duration-200 ${
                isActive('/bazi') || isActive('/ziwei') || isActive('/western') || isActive('/vedic') || isActive('/tools') ? 'text-[#B23E26]' : 'text-[#5A5247] hover:text-[#B23E26]'
              }`}
            >
        ...
        {/* Mobile toggle */}
        <button
          className="md:hidden flex items-center justify-center p-[10px] -m-[10px] text-[#2B241C] hover:text-[#B23E26]"
      ...
      {open && (
        <div id="mobile-menu" className="md:hidden bg-[#FAFAF8] border-t border-[#2B241C]/10 px-4 py-6 flex flex-col gap-4 max-h-[80vh] overflow-y-auto">
          ...
          <div className="flex flex-col gap-2 pl-3">
            <Link href="/tools" onClick={() => setOpen(false)} className="text-[13px] font-semibold text-[#B23E26] hover:underline transition-colors">
              所有工具總覽 →
            </Link>
